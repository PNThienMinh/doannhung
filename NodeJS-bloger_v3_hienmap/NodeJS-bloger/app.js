...
//phần mới thêm 
var BattleshipGame = require('./apps/app/game.js');
var GameStatus = require('./apps/app/gameStatus.js');
...
//Static folder thư mục chứa css, js, images của ứng dụng
app.use(express.static(__dirname + "/public"));

// __dirname trả về vị trí hiện tại
